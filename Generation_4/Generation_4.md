...
- [Watch 4.0](./Watch4.0/Watch4.0.ino) is the first gadget of the 4th generation, and has an almost identical program and components to [Watch 3.0](../Generation_3/Watch3.0/Watch3.0.ino) but uses a more cost effective ATTiny chip.
- [Watch 4.1](./Watch4.1/Watch4.1.ino) uses some buttons and a potentiometer to give a second generation like extension blink capability.
- [Watch 4.2](./Watch4.2/Watch4.2.ino) is almost identical to Watch 3.2, however uses a PCB to improve stability and appearance.
...
6. Build or order the PCB required for the gadget.
7. Solder the parts to the PCB.
8. Select the appropriate port and chip.
