...
A clear and concise description of the technical debt. Explain why it needs to be addressed and what impact it has on the gadget.

**Location** (compulsory)
Specify where in which program the technical debt is located. Provide file names, line numbers, and/or links to the relevant code.

**Impact** (optional)
Describe the impact of the technical debt. How does it affect development, performance, maintainability, or other aspects of the gadget?
