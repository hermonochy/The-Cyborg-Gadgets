...
- [Watch 3.3](./Watch3.3/Watch3.3.ino) is an adapted version of [Watch 3.2](./Watch3.2/Watch3.2.ino), using a 64x32px display rather than a 128x64px one. It is also the smallest watch featuring a display.
